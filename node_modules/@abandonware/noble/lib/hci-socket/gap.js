...
Gap.prototype.startScanning = function (allowDuplicates) {
  ...
  // Remove any previous listener to avoid stacking on repeated calls.
  this._hci.removeAllListeners('leScanParametersSet');
  // Wait for setScanParameters confirmation before enabling scan.
  // On Intel HCI adapters the chip needs the command response before
  // it will accept setScanEnabled(true), unlike BCM chips on Pi hardware.
  this._hci.once('leScanParametersSet', () => {
